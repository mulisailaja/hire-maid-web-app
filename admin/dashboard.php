...
$sql3 ="SELECT * from  tblmaidbooking where Status='Pending' ";
...
?>
                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30" style="height: 255px;">
                              <div class="couter_icon">
                                 <div> 
...
$totcat=$query1->rowCount();
?>
                                    <p class="head_couter" style="margin-top: 35px;">Feedbacks<br /><br />
                                       <a href="adminfeedback.php" class="btn btn-primary btn-sm" style="margin-top: 25px;">View Details</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
